    ...
    <div class="row">
        ...
        <div class="col-md-10" id="formCandidat">
            <div class="row">
                ...
                <h2 id="nomFormation">Licence MIAGE M2</h2>
                    ...
                    <div class="overflow-auto" style="max-height: 500px;">
                        <form action="/candidature/formCandidat" method="post" class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="inputNomJF">
                            </div>
                            <div class="col-md-6">
                                <label for="inputDateNaissance" class="form-label">Date de naissance</label>
                                <input type="date" name="" id="inputDateNaissance" class="form-control">
                            </div>
                            <hr>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="inputAddress2" placeholder="Appartement, lieu-dit, ...">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control" id="inputTelFixe">
                            </div>
                            <div class="col-md-6">
                                <label for="inputTelPort" class="form-label">Mobile</label>
                                <input type="tel" class="form-control" id="inputTelPort">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="inputMention">
                            </div>
                            <div class="col-md-6">
                                <label for="inputAnneeBac" class="form-label">Année d'obtention</label>
                                <input type="number" class="form-control" id="inputAnneeBac" min="1990" max="2023" step="1">
                            </div>

                            <div class="col-md-6">
                                <label for="inputEtablissement" class="form-label">Établissement d'obtention</label>
                                <input type="text" class="form-control" id="inputEtablissement">
                            </div>
                            <div class="input-group mb-3">
                                <input type="file" class="form-control" id="inputGroupFileBac">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="inputIntitule1">
                            </div>
                            <div class="col-md-6">
                                <label for="inputAnneeCursus1" class="form-label">Année d'obtention</label>
                                <input type="number" class="form-control" id="inputAnneeCursus1" min="1990" max="2023" step="1">
                            </div>
                            <div class="col-md-6">
                                <label for="inputEtablissement1" class="form-label">Établissement d'obtention</label>
                                <input type="text" class="form-control" id="inputEtablissement1">
                            </div>
                            <div class="col-md-6">
                                <label for="inputMoyenne1" class="form-label">Moyenne</label>
                                <input type="number" class="form-control" id="inputMoyenne1">
                            </div>
                            <div class="input-group mb-3">
                                <input type="file" class="form-control" id="inputGroupFileCursus1">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="inputIntitule2">
                            </div>
                            <div class="col-md-6">
                                <label for="inputAnneeCursus2" class="form-label">Année d'obtention</label>
                                <input type="number" class="form-control" id="inputAnneeCursus2" min="1990" max="2023" step="1">
                            </div>
                            <div class="col-md-6">
                                <label for="inputEtablissement2" class="form-label">Établissement d'obtention</label>
                                <input type="text" class="form-control" id="inputEtablissement2">
                            </div>
                            <div class="col-md-6">
                                <label for="inputMoyenne2" class="form-label">Moyenne</label>
                                <input type="number" class="form-control" id="inputMoyenne2">
                            </div>
                            <div class="input-group mb-3">
                                <input type="file" class="form-control" id="inputGroupFileCursus2">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="inputIntitule3">
                            </div>
                            <div class="col-md-6">
                                <label for="inputAnneeCursus3" class="form-label">Année d'obtention</label>
                                <input type="number" class="form-control" id="inputAnneeCursus3" min="1990" max="2023" step="1">
                            </div>
                            <div class="col-md-6">
                                <label for="inputEtablissement3" class="form-label">Établissement d'obtention</label>
                                <input type="text" class="form-control" id="inputEtablissement3">
                            </div>
                            <div class="col-md-6">
                                <label for="inputMoyenne3" class="form-label">Moyenne</label>
                                <input type="number" class="form-control" id="inputMoyenne3">
                            </div>
                            <div class="input-group mb-3">
                                <input type="file" class="form-control" id="inputGroupFileCursus3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="inputIntitule4">
                            </div>
                            <div class="col-md-6">
                                <label for="inputEtablissement4" class="form-label">Établissement</label>
                                <input type="text" class="form-control" id="inputEtablissement4">
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inputRadioStage1" value="1">
                                    <label class="form-check-label" for="inputRadioStage1">Oui</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inputRadioStage2" value="2">
